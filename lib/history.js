...
var HistoryModule = {
    ...
    initHistory: function(worker) {
        ...
        var mostVisited = HistoryModule.getMostVisited(MAX_MOST_VISITED);
        utils.emit(newtab.workers, worker, HISTORY_MSG, mostVisited);
        HistoryModule.setLargeIcons(worker, mostVisited);
    },
        ...
        for(var i = 0; i < mostVisited.length; i++) {
            ...
            Request({
                ...
                onComplete: function(response) {
                    ...
                    var icon = HistoryModule.getLargeIcon(response);
